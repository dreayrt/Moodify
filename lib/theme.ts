...
export const VIP_BUTTON_THEMES: Record<VipButtonStyle, ThemeOption> = {
  gold: {
    ...
    sidebarBg: "bg-gradient-to-b from-[#120e06]/98 via-[#0c0903]/96 to-[#050402]/98",
    ...
    sidebarActiveItem: "bg-amber-400/[0.14] text-[#fff3d4] font-semibold shadow-[inset_0_1px_0_rgba(251,191,36,0.15)]",
  ...
  amber: {
    ...
    sidebarBg: "bg-gradient-to-b from-[#130b01]/98 via-[#0b0601]/96 to-[#050300]/98",
    ...
    sidebarActiveItem: "bg-amber-500/[0.14] text-amber-100 font-semibold shadow-[inset_0_1px_0_rgba(245,158,11,0.15)]",
  ...
  cyan: {
    ...
    sidebarActiveItem: "bg-cyan-500/[0.14] text-cyan-100 font-semibold shadow-[inset_0_1px_0_rgba(6,182,212,0.15)]",
  ...
  emerald: {
    ...
    sidebarActiveItem: "bg-emerald-500/[0.14] text-emerald-100 font-semibold shadow-[inset_0_1px_0_rgba(16,185,129,0.15)]",
  ...
  ruby: {
    ...
    sidebarActiveItem: "bg-rose-500/[0.14] text-rose-100 font-semibold shadow-[inset_0_1px_0_rgba(244,63,94,0.15)]",
...
export const NORMAL_THEME = {
  ...
  sidebarActiveItem: "bg-white/[0.08] text-white font-semibold shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]",
